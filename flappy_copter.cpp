...
setlinestyle(0,0,1);
settextstyle(10,0,3);
outtextxy(80,getmaxy()-i,"FLAPPY");
outtextxy(330,getmaxy()-i,"COPTER");
settextstyle(3,0,4);
...
case 4:
	...
	break;
default : cout<<"\n\nThere is some error in the game....CONTACT DEVELOPER at contactankitthakur@gmail.com";
}
...
switch(selected)
{
 ...
 case 3 : cleardevice();
	 ...
	 // bar(0,getmaxy()-50,getmaxx(),getmaxy());
	  ...
	  outtextxy(80,getmaxy()/2,"Developed by :");
	 outtextxy(350,getmaxy()/2,"Ankit Kumar");
	  outtextxy(350,getmaxy()/2+70,"MCA IV Sem");
	  settextstyle(2,0,5);
	  setcolor(RED);
